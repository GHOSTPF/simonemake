{{--
    Ícone SVG inline. Uso: @include('partials._icon', ['name' => 'academic-cap', 'class' => 'h-6 w-6'])
    Ícones: Heroicons (outline) + marcas. Adicione novos casos conforme precisar.
--}}
@php($cls = $class ?? 'h-6 w-6')

@switch($name)
    @case('academic-cap')
        <svg class="{{ $cls }}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" aria-hidden="true">
